...
public class GaussianBlur {
    ...
    public Bitmap render(Bitmap source) {
        ...
        @SuppressLint({"NewApi", "LocalSuppress"}) ScriptIntrinsicBlur script = ScriptIntrinsicBlur.create(rs, inAlloc.getElement()); // Element.U8_4(rs));
    ...
    public void put(Drawable drawable, ImageView imageView) {
        new GaussianBlur.BitmapGaussianAsync(imageView).execute(((BitmapDrawable) drawable).getBitmap());
    }

    @UiThread
    public void put(Bitmap bitmap, ImageView imageView) {
        new GaussianBlur.BitmapGaussianAsync(imageView).execute(bitmap);
    }

    @UiThread
    public void put(int res, ImageView imageView) {
        new GaussianBlur.ResourceGaussianAsync(imageView).execute(res);
    }
     ...
     */
    class ResourceGaussianAsync extends GaussianBlur.GaussianAsync<Integer> {
     ...
     */
    class BitmapGaussianAsync extends GaussianBlur.GaussianAsync<Bitmap> {

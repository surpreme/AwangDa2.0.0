 ...
 */
@Route(path = "/jn/DialogueActivity")
                ...
                new TIMValueCallBack<List<TIMMessage>>() {//回调接口
                    ...
                    public void onError(int code, String desc) {//获取消息失败
                        ...
                        if (chatListAdapter == null) {
                            ...
                            if (application == null) application = (APPSingleton) getApplication();
                            if (application.iMUserSigInfo == null) return;
                            if (application.iMUserSigInfo.datas == null) return;
                    ...
                    public void onSuccess(List<TIMMessage> msgs) {//获取消息成功
                        ...
                        isRefresh = false;
                        //根据时间戳排序
                        Collections.sort(msgs, (Comparator) (o1, o2) -> {

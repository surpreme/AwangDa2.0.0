 ...
 * @desc:
 */
public class SettingPlatformServiceItemViewModel extends ItemViewModel<SettingFragmentViewHolder> {
    private int mTitleId = 0;

    public SettingPlatformServiceItemViewModel(@NonNull SettingFragmentViewHolder viewModel, int icon, int titleId) {
        super(viewModel);
...
//,TopUpActivity.class);
            ...
            } else if (mTitleId == R.string.messageNotification) {//消息提醒
                Intent intent33 = new Intent(ActivityManager.getInstance().getCurrentActivity()

        ...
        if (mDatas.get(position).getGoods_lists().size() > 0) {
            ...
            holder.photo1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("goods_id", mDatas.get(position).getGoods_lists().get(0).getGoods_id());  intent.putExtra("key",
                            Mark.State.UserKey);
            ...
            if (mDatas.get(position).getGoods_lists().size() > 1) {
                ...
                holder.photo2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(context,
                                ProductDetailsKotlinActivity.class);
                        intent.putExtra("goods_id", mDatas.get(position).getGoods_lists().get(1).getGoods_id());  intent.putExtra("key",
                                Mark.State.UserKey);
                        context.startActivity(intent);
                    }
                });
                ...
                if (mDatas.get(position).getGoods_lists().size() > 2) {
                    ...
                    holder.photo3.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent intent = new Intent(context,
                                    ProductDetailsKotlinActivity.class);
                            intent.putExtra("goods_id", mDatas.get(position).getGoods_lists().get(2).getGoods_id());  intent.putExtra("key",
                                    Mark.State.UserKey);
                            context.startActivity(intent);
                        }
                    });

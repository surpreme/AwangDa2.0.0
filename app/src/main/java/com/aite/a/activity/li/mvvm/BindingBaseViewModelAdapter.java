 ...
 * @desc:
 */
public final class BindingBaseViewModelAdapter extends BaseModel {
    /**
     * 设置中划线
     ...
     * @param listener
     */
    @BindingAdapter(value = {"onCheckedListener"}, requireAll = false)
    public static void setOnCheckedListener(
            CheckBox checkBox,

...
public class HotIntegralGiftListActivity extends BaseActivity implements
    ...
    private class MygiftAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.redeem_tv.setOnClickListener(v -> {
                Intent intent2 = new Intent(HotIntegralGiftListActivity.this, IntegralGoodsInfoActivity.class);
        ...
        class ViewHolder {
            ...
            TextView tv_gift_goodsname, tv_costnum, tv_points, redeem_tv;
//					, bt_exchange;
            ...
            public ViewHolder(View convertView) {
                ...
                redeem_tv = (TextView) convertView
                        .findViewById(R.id.redeem_tv);

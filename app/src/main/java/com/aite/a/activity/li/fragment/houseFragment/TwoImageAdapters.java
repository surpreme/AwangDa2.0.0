...
public class TwoImageAdapters extends BaseAdapter {
    public List<HouseUIBean.Home3Bean.ItemBean> item;
    private Context mcontext;
    private int getw;

    public TwoImageAdapters(List<HouseUIBean.Home3Bean.ItemBean> item, Context mcontext, int getw) {
        this.item = item;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final HouseUIBean.Home3Bean.ItemBean item2 = item
                .get(position);
        // 获取图片真正的宽高
        Glide.with(mcontext).asBitmap().load(item2.getImage())// 强制Glide返回一个Bitmap对象
        ...
        Glide.with(mcontext).load(item2.getImage()).into(holder.iv_img7);
        holder.iv_img7.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("url", item2.getData());

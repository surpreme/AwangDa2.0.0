		...
		public View getView(final int position, View convertView,
			...
			handler.ll_vr_goods.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					Intent intent2 = new Intent(VrOrder.this, ProductDetailsKotlinActivity.class);
					intent2.putExtra("goods_id", vrorder_list.get(position).goods_id);  intent.putExtra("key",
							State.UserKey);

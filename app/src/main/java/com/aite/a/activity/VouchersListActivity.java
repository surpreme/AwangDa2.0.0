...
public class VouchersListActivity extends BaseActivity implements
    ...
    private class AllAdapter extends BaseAdapter {
        ...
        @Override
        public int getCount() {
            return voucher_list == null ? 0 : voucher_list.size();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.until_time_tv.setText(getString(R.string.order_reminder87)
                    + TimeStamp2Date(voucher_list2.voucher_start_date,
                    "yyyy-MM-dd")
                    + " ~ "
                    + TimeStamp2Date(voucher_list2.voucher_end_date,
                    "yyyy-MM-dd"));
            holder.state_tv.setText(voucher_list2.voucher_state_text);
            holder.goods_name_tv.setText(voucher_list2.voucher_title);
            holder.price_information_tv.setText(String.format("$:%s 满%s减%s", voucher_list2.voucher_price, voucher_list2.voucher_limit, voucher_list2.voucher_price));
            holder.goods_number_tv.setText(String.format("代金券编码：%s", voucher_list2.voucher_code));
            if (voucher_list2.voucher_state.equals("1")) {
                holder.state_tv.setBackgroundResource(R.drawable.integral_6);
                holder.state_tv.setTextColor(Color.WHITE);
            } else {
                holder.state_tv.setBackgroundResource(R.drawable.integral_7);
                holder.state_tv.setTextColor(Color.BLACK);
            }
            holder.state_tv.setOnClickListener(new OnClickListener() {
...
//					}
        ...
        class ViewHolder {
            ...
            TextView price_information_tv, goods_name_tv, goods_number_tv, until_time_tv, state_tv;
            ImageView iv_img;

            public ViewHolder(View convertView) {
                price_information_tv = (TextView) convertView.findViewById(R.id.price_information_tv);
                goods_name_tv = (TextView) convertView.findViewById(R.id.goods_name_tv);
                goods_number_tv = (TextView) convertView.findViewById(R.id.goods_number_tv);
                until_time_tv = (TextView) convertView.findViewById(R.id.until_time_tv);
                state_tv = (TextView) convertView.findViewById(R.id.state_tv);

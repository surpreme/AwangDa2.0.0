                    ...
                    if (msg.obj == null) {
                        ...
                        if (isrefresh) {
                            ...
                            if (personalDataInfo.member_sex == null || personalDataInfo.member_sex.equals("-1") || personalDataInfo.member_sex.equals("0")) {
                                ...
                                rbBoyGender.setChecked(true);
                            } else {
                                tv_gender.setText(sexArry[Integer.parseInt(personalDataInfo.member_sex) - 1]);
                                if (personalDataInfo.member_sex.equals("1")) {
                                    rbBoyGender.setChecked(true);
                                } else if (personalDataInfo.member_sex.equals("2")) {
                                    rbGrilGender.setChecked(true);
                                } else if (personalDataInfo.member_sex.equals("3")) {
                                    rbUnknowGender.setChecked(true);
    ...
    private void initRadioGroup() {
        radiogroupGender.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.rb_boy_gender:
                        sex = "1";
                        break;
                    case R.id.rb_gril_gender:
                        sex = "2";
                        break;
                    case R.id.rb_unknow_gender:
                        sex = "3";
                        break;
                    default:
                        break;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.rl_avatar://头像
                UpdatePhotosFragment mUpdatePhotosFragment = new UpdatePhotosFragment();
                mUpdatePhotosFragment.setMlistener(new OnClickLstenerInterface.OnThingClickInterface() {
                    @Override
                    public void getThing(Object msg) {
                ...
                mUpdatePhotosFragment.show(getSupportFragmentManager(),"UpdatePhotosFragment");
//                editAvatar();
                break;
...
//                mCountry_id = data.getStringExtra("country_id");//国家
            if (data.getStringExtra("province_id") != null)
                province_id = data.getStringExtra("province_id");//省
            if (data.getStringExtra("city_id") != null)
                city_id = data.getStringExtra("city_id");//市
            if (data.getStringExtra("area_id") != null)
                area_id = data.getStringExtra("area_id");//区choice_end_name
            if (data.getStringExtra("choice_end_name") != null) {
                tv_address.setText(data.getStringExtra("choice_end_name"));
            }
        } else {

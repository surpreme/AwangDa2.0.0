            ...
            switch (msg.what) {
                case integral_mall_id:
                    if (msg.obj != null) {
                        ...
                        if (integralMallInfo == null) return;
                        if (integralMallInfo.member_info == null) return;
                        tv_integral
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.tv_valid_time.setText(getString(R.string.evaluation_tips18)
                    + (com.valy.baselibrary.utils.ClutterUtils.isInteger(recommend_voucher2.voucher_t_end_date) ? TimeStamp2Date(recommend_voucher2.voucher_t_end_date,
                    "yyyy-MM-dd HH:mm") : recommend_voucher2.voucher_t_end_date));
...
//			holder.bt_exchange.setText("兑换");
    ...
    private class MygiftAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.tv_costnum.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG);
            holder.tv_points.setText(recommend_pointsprod2.pgoods_points + getString(R.string.integrall));
//            LinearLayoutCompat layoutParams = (LinearLayoutCompat) holder.iv_gift_image.getLayoutParams();

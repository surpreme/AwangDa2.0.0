...
//		Intent i_main = new Intent(this, JDHomePage.class);
        ...
        Intent i_category = new Intent(this, FavoriteListFargmentActivity.class);
//		Intent i_category = new Intent(this, CategoryActivity.class);
        ...
        Intent i_message = new Intent(this, AroundActivity.class);
...
//                Log.i("------------------","定位  省="+province+"  市="+city+"  区="+district);
    ...
    public static void goToSetting(Context context) {
        ...
        Uri uri = Uri.fromParts("package", "com.jiananshop.a", null);
        intent.setData(uri);

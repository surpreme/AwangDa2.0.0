...
public class OrderGroupListAdapter extends BaseAdapter {
    ...
    private List<OrderGroupList> mOrderList6 = new ArrayList<OrderGroupList>();
    private int what;
    ...
    public Object getItem(int position) {
        switch (what) {
         ...
         case 5:
                return mOrderList6.get(position);
        }
        return null;
    }
    ...
    public void addOrderList(List<OrderGroupList> mOrderList) {
        switch (what) {
            ...
            case 4:
                ...
                break;
       case 5:
                this.mOrderList6.addAll(mOrderList);
                break;
        }
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (onQrCodeReturnInterface != null)
            orderAdapter.setOnQrCodeClickInterface(qr_code -> {
                onQrCodeReturnInterface.onClick(qr_code);
            });
...
//        Intent intent = new Intent(activity, SurePayListActivity.class);
        Intent intent = new Intent(ActivityManager.getInstance().getCurrentActivity(), SurePayListKotlinActivity.class);

...
public class NetRun implements Mark {
    ...
    private boolean AngainLogIn(String response) {
        try {
    ...
    public void Intex(final Sqlutls sqlutls) {
        ...
        httpUtils.send(HttpMethod.GET, index, new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> response) {
                if (AngainLogIn(response.result)) {
    ...
    private void againLogIn() {
        ...
        if (BaseConstant.LOGINAWAY.equals("isMobile")) {
            RetrofitClients.getInstance().getRetrofit().create(RetrofitInterface.class)
                ...
                State.UserKey = logInBean.getKey();
                State.UserName = logInBean.getUsername();
                State.Member_id = logInBean.getConfig().getMember_id();
            }, throwable -> {
    ...
    public void getGoodsList(String key, String order, String page,
        ...
        params.addQueryStringParameter("language_type", BaseConstant.CURRENTLANGUAGE);
        params.addQueryStringParameter("lang_type", BaseConstant.CURRENTLANGUAGE);
    ...
    public void getCategorOne() {
        ...
        params = new RequestParams();
        params.addQueryStringParameter("lang_type", BaseConstant.CURRENTLANGUAGE);
        httpUtils.send(HttpMethod.GET, category, params, new RequestCallBack<String>() {
            @Override
            public void onSuccess(ResponseInfo<String> responseInfo) {
                if (AngainLogIn(responseInfo.result)) {
...
//                                two_category_err, msg));
    ...
    public void getFavoriteList(final String fav_type, final int arg1) {
        httpUtils = new HttpUtils();
        params = new RequestParams();
        params.addBodyParameter("language_type", BaseConstant.CURRENTLANGUAGE);
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        if (AngainLogIn(responseInfo.result)) {
                            handler.sendMessage(handler.obtainMessage(nearby__id,
                                    JsonParse.getNearby(responseInfo.result)));
                        }
                ...
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        if (AngainLogIn(responseInfo.result)) {
                            handler.sendMessage(handler.obtainMessage(
                                    nearbySelectCity__id,
                                    JsonParse.getNearbySelectCity(responseInfo.result)));
                        }
                    }
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        if (AngainLogIn(responseInfo.result)) {
                            handler.sendMessage(handler.obtainMessage(
                                    ...
                                    JsonParse.getNearbySelectArea(responseInfo.result)));
                        }
                ...
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        if (AngainLogIn(responseInfo.result)) {
                            handler.sendMessage(handler.obtainMessage(
                                    open_store_id,
                                    JsonParse.personaLopenShop(responseInfo.result)));
                        }
...
//    public void smaRegister(String regtype,String phone, String secret,String password,String password_confirm,String email) {
    ...
    public void getOrderList(final String order_state, String page,
        ...
        if (!order_state.equals("0"))
            params.addQueryStringParameter("type", order_state);
        params.addQueryStringParameter("curpage", curpage);
        params.addQueryStringParameter("key", State.UserKey);
        httpUtils.send(HttpMethod.GET, order_list, params,
                new RequestCallBack<String>() {
                    @Override
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        if (AngainLogIn(responseInfo.result)) {
...
//                        img.delete();
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        try {
                            ...
                            if (datas != null) {
                                ...
                                if (error != null && !error.isEmpty()) {
                                    ToastUtils.showToast(ActivityManager.getInstance().getCurrentActivity(), error);
                                    handler.sendMessage(handler
    ...
    public void IntegarlOrderInfo(final String order_id) {
        RetrofitClient.getInstance().getRetrofit().create(RetrofitInterface.class)
                .getUseOrderInfo(State.UserKey, order_id, BaseConstant.CURRENTLANGUAGE)
                .compose(RxScheduler.Flo_io_main())
                .subscribe(new Consumer<ResponseBody>() {
                    ...
                    public void accept(ResponseBody responseBody) throws Exception {
                        ...
                        if (!error.isEmpty()) {
                            ...
                            IntegarlOrderInfo integarlOrderInfo = new Gson().fromJson(datas.toString(), type);
                            handler.sendMessage(handler.obtainMessage(

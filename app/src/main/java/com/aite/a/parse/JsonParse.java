    ...
    public static Object buySteOne(String result) {
        ...
        try {
            ...
            while (keys.hasNext()) {
                ...
                JSONArray store_voucher_listArry = digital.optJSONArray("store_voucher_list");
//                String store_voucher_list = digital
//                        .getString("store_voucher_list");
                String store_voucher_list = store_voucher_listArry != null ? store_voucher_listArry.toString() : "";
...
//                JSONObject jsonObject = object.getJSONObject("datas");
    ...
    public static Object getExchangeRecordInfo(String result) {
        try {
            ...
            JSONObject object = new JSONObject(result);
//            JSONObject jsonObject = object.getJSONObject("datas");
            JSONArray jsonObject = object.optJSONArray("datas");
            List<ExchangeRecordInfo> exchangeRecordInfos = new Gson().fromJson(jsonObject.toString(), new TypeToken<List<ExchangeRecordInfo>>() {
            }.getType());

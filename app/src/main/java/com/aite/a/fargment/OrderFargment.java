...
public class OrderFargment extends Fragment implements OnHeaderRefreshListener, OnFooterRefreshListener {
    ...
    private String curpage = "1", curpage2 = "1", curpage3 = "1", curpage4 = "1", curpage5 = "1", curpage6 = "1";

    public void setCurrentIndex(int currentIndex) {
        this.currentIndex = currentIndex;
    }

//    public OrderFargment newInstance(String s) {
//
//
//    }

    private OrderGroupListAdapter orderAdapter, orderAdapter2, orderAdapter3, orderAdapter4, orderAdapter5, orderAdapter6;
                ...
                case Mark.order_list_id:
                    if (msg.obj == null) {
                        ...
                        if (currentIndex == 4 && Integer.valueOf(curpage5) > 1)
                            CommonTools.showShortToast(getActivity(), APPSingleton.getContext().getString(R.string.no_more_data).toString());
                        if (currentIndex == 5 && Integer.valueOf(curpage6) > 1)
                            CommonTools.showShortToast(getActivity(), APPSingleton.getContext().getString(R.string.no_more_data).toString());
                        return;
                    }
                    switch (currentIndex) {
                        ...
                        case 5:
                            if (((List<OrderGroupList>) msg.obj).size() > 0) {
                                orderAdapter6.addOrderList((List<OrderGroupList>) msg.obj);
    ...
    private void initView() {
        ...
        switch (currentIndex) {
            case 0:
                ...
                orderAdapter.setOnQrCodeReturnInterface(qr_number -> {
                    PickupCodeDialogFragment.newInstance(qr_number).show(
                            getChildFragmentManager(), "PickupCode");
                });
            ...
            case 1:
                ...
                orderAdapter2.setOnQrCodeReturnInterface(qr_number -> {
                    PickupCodeDialogFragment.newInstance(qr_number).show(
                            getChildFragmentManager(), "PickupCode");
                });
            ...
            case 2:
                ...
                orderAdapter3.setOnQrCodeReturnInterface(qr_number -> {
                    PickupCodeDialogFragment.newInstance(qr_number).show(
                            getChildFragmentManager(), "PickupCode");
                });
            ...
            case 3:
                ...
                orderAdapter4.setOnQrCodeReturnInterface(qr_number -> {
                    PickupCodeDialogFragment.newInstance(qr_number).show(
                            getChildFragmentManager(), "PickupCode");
                });
            ...
            case 4:
                ...
                orderAdapter5.setOnQrCodeReturnInterface(qr_number -> {
                    PickupCodeDialogFragment.newInstance(qr_number).show(
                            getChildFragmentManager(), "PickupCode");
                });
                ...
                break;
            case 5:
                orderAdapter6 = new OrderGroupListAdapter(getActivity(), currentIndex, handler);
                orderAdapter6.setOnQrCodeReturnInterface(qr_number -> {
                    PickupCodeDialogFragment.newInstance(qr_number).show(
                            getChildFragmentManager(), "PickupCode");
                });
                listView.setAdapter(orderAdapter6);
                break;
            default:
            ...
            public void run() {
                ...
                switch (currentIndex) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        show_add = Integer.valueOf(curpage6);
                        show_add = show_add + 1;
                        curpage6 = String.valueOf(show_add);
                        break;
                }
    ...
    private void Refresh() {
        switch (currentIndex) {
            ...
            case 5:
                curpage6 = "1";
                orderAdapter6.clear();
                netRun.getOrderList(String.valueOf(currentIndex), page, curpage6);
                break;
        }
    }

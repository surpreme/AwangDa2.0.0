    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_setting://设置
                break;
            case R.id.rl_menu1://我的群组
                Intent intent2 = new Intent(getActivity(), MyGroupActivity.class);
                startActivity(intent2);
                break;
            case R.id.rl_menu2://我的活动
                Intent intent = new Intent(getActivity(), MyDoingsActivity.class);
                startActivity(intent);
                break;
            case R.id.rl_menu3://我的帖子
                break;
            case R.id.rl_menu4://订单管理
                break;
            case R.id.rl_menu5://我的购物车
                break;
            case R.id.rl_menu6://会员套餐
                break;
            case R.id.rl_menu7://意见反馈
                break;
            case R.id.rl_menu8://退出登陆
                break;
        }
    }
}
